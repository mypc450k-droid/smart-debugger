    ...
    methods (Access=private)
        function result = run(obj,model,block,stopTime,mode)
            ...
            try
                ...
                % Name-value arguments override configuration for this run.
        ...
        function ports = instrumentPorts(obj,block,direction,tx)
            ...
            for k = 1:numel(hs)
                ...
                % Reuse a logging name when several selected ports share a source.
                ...
                if isempty(existing)
                    ...
                    tx.record(srcPort,'DataLogging',obj.safeGetParam(srcPort,'DataLogging','off'));
                    tx.record(srcPort,'DataLoggingNameMode',obj.safeGetParam(srcPort,'DataLoggingNameMode','SignalName'));
                    tx.record(srcPort,'DataLoggingName',obj.safeGetParam(srcPort,'DataLoggingName',''));
